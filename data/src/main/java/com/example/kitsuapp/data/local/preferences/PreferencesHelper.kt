package com.example.kitsuapp.data.local.preferences

import android.content.Context
import android.content.SharedPreferences
import com.example.kitsuapp.data.local.preferences.PreferencesKeys.ACCESS_TOKEN_KEY
import com.example.kitsuapp.data.local.preferences.PreferencesKeys.IS_AUTHENTICATED
import com.example.kitsuapp.data.local.preferences.PreferencesKeys.LOGIN_KEY
import com.example.kitsuapp.data.local.preferences.PreferencesKeys.PASSWORD_KEY
import com.example.kitsuapp.data.local.preferences.PreferencesKeys.REFRESH_TOKEN_KEY
